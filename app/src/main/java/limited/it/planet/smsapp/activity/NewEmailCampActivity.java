...
public class NewEmailCampActivity extends DemoActivity {
    Toolbar toolbar;
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_email_camp);
    ...
    public void initializeUI(){
        sessionClear = new SessionClear(NewEmailCampActivity.this);
       ...
       // imgvHome = (ImageView)findViewById(R.id.imgv_home);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // onBackPressed();
                Intent intent = new Intent(NewEmailCampActivity.this,EmailDashboard.class);
                startActivity(intent);
                ActivityCompat.finishAffinity(NewEmailCampActivity.this);
            }
        });

        //listDialogue();
        fontCustomization = new FontCustomization(NewEmailCampActivity.this);
        txvToolbarHead.setTypeface(fontCustomization.getTexgyreHerosBold());
//        progressBar = ProgressDialog.show(NewEmailCampActivity.this,
//                getString(R.string.progress_please_wait), getString(R.string.progress_loading));
//        progressBar.setCancelable(true);

       // startProgress();
        loadNewEmailCampaignsWebView();
    }

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    public void loadNewEmailCampaignsWebView(){
        ...
        webView.setWebViewClient(new WebViewClient() {
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                //view.loadUrl(url);
                viewDialog.showDialog(NewEmailCampActivity.this,"This Service is not Available for this account.");
...
//                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_new_email_campaign, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.new_email_campaign_logout:

                clearCookies(NewEmailCampActivity.this);
                saveBoleanValueSharedPreferences("islogin",false,NewEmailCampActivity.this);

                Intent intent = new Intent(NewEmailCampActivity.this,LoginActivity.class);
                startActivity(intent);
                ActivityCompat.finishAffinity(NewEmailCampActivity.this);
                break;
